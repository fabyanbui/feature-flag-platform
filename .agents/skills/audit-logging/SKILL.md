---
name: audit-logging
description: Use when adding or reviewing mutation flows that must write append-only audit log entries with actor, timestamp, target, before/after snapshots, transaction boundaries, and query filters.
---
