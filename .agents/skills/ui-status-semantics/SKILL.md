...
description: Use when designing or reviewing admin/demo UI status displays, especially separating feature flag status labels from runtime On/Off state and keeping indicators accessible.
---
