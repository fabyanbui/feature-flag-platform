...
description: Use before demo or release to review requirements alignment, API conventions, deterministic evaluation, data integrity, audit logging, UI semantics, security, and test coverage.
---
