...
- PostgreSQL is the primary relational database; SQLite is acceptable for local demo work.
- MVP tech stack: NestJS, Prisma, REST APIs with Swagger, Jest, and in-memory cache.
...
- Evaluation must be deterministic for the same configuration and context.
